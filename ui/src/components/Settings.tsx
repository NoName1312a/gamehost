...
export function Settings({
  ...
  async function removeAllServers() {
    ...
    try {
      ...
      setPurgeMsg(`Removed ${r.removed} server${r.removed === 1 ? "" : "s"}. Navigate away and back to refresh.`);
    } catch (e) {
      ...
      <div className="mx-auto max-w-2xl px-6 py-8">
        ...
        <div className="space-y-5">
          ...
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Version info</h2>
            <dl className="space-y-1 text-sm">
              <div className="flex justify-between">
                <dt className="text-zinc-500">App version</dt>
                <dd className="font-mono text-zinc-200">{appVer ?? (isDesktop() ? "…" : "browser")}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Engine version</dt>
                <dd className="font-mono text-zinc-200">{engineVersion ?? "—"}</dd>
              </div>
            </dl>
          </section>
          ...
          {/* Updates */}
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Updates</h2>
            {isDesktop() ? (
              ...
              <p className="text-xs text-zinc-500">Updates are managed by the desktop app.</p>
            )}
          </section>

          {/* Remote access */}
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Remote access</h2>
          ...
          <section className="panel p-5">
            <div className="mb-3 flex items-center justify-between">
              <h2 className="font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Supporter</h2>
              {license?.pro && (
          ...
          {/* Off-site backups */}
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Off-site backups</h2>
            <p className="mb-3 text-xs text-zinc-500">
          ...
          {/* Diagnostics */}
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Diagnostics</h2>
            <p className="mb-3 text-xs text-zinc-500">
          ...
          {/* Danger zone */}
          <section className="panel p-5">
            <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-rose-300">Danger zone</h2>
            <p className="mb-3 text-xs text-zinc-500">
            ...
            <button
              ...
              disabled={purgeBusy}
              className="w-full rounded-lg border border-rose-500/40 px-3 py-2 text-sm font-semibold text-rose-300 hover:bg-rose-500/10 disabled:opacity-50"
            >
          ...
          {isOwner && (
            <section className="panel p-5">
              <h2 className="mb-3 font-display text-sm font-semibold uppercase tracking-wide text-zinc-400">Users</h2>
              <p className="mb-3 text-xs text-zinc-500">
